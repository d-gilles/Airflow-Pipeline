...
yellow_taxi_to_bq_dag = DAG(
    'yellow_taxi_to_bq_dag',
    description='Pipeline to ingest data of yellow taxi to bigquery',
    schedule_interval='0 16 5 * *',
    start_date=datetime(2021, 1, 1),
    end_date=datetime(2022, 12, 31),
    tags = ['ingest', 'gcp', 'bigquery','nytaxi','yellow'],
    concurrency=1,
    max_active_runs=2
)
